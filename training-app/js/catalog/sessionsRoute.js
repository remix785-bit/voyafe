...
export const SESSIONS_ROUTE = [
  ...
  },
  {
    ...
    rpe: "3-4",
    corpsDeSeance: {
      format: "Continu, variante développement: 4-6 lignes droites 15-20s allure R en fin de séance",
      dureeMin: [45, 150],
  ...
  },
  {
    ...
    rpe: "6-7",
    corpsDeSeance: {
      format: "Tempo continu ≤20 min OU cruise intervals (1.6-3.2 km, récup 1-2 min)",
  ...
  },
  {
    ...
    rpe: "8-9",
    corpsDeSeance: {
      format: "Répétitions ≤2 min (200-400 m typiquement)",
